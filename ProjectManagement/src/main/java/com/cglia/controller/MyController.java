...
public class MyController {
	...
	public String saveProject(@ModelAttribute ProjectModel proje, HttpServletRequest request, RedirectAttributes attrs) {
		System.out.println(proje);
		Integer id=service.saveProject(proje);
		attrs.addFlashAttribute("ProjectId", id);
		if(id>0) {
			attrs.addFlashAttribute("successmsg","Poject added successfully with ID:"+id);
		}else {
